                    ...
                    <div class="">
                        <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9">
                                    <input type="text" id="form-field-1" placeholder="" value="<?= $nota->f_alamat ?>" readonly class="col-sm-5" />
                                </div>
                            </div>
                            <br>
                            <div class="row">
                ...
                <div class="col-xs-12" style="margin-top: 30px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9">
                            ...
                            <input class="col-xs-10" type="text" id="form-field-1" value="<?= $nota->fv_terbilang ?>" placeholder="" class="col-xs-11" />
                        </div>
                        <div class="col-xs-3">
